...
public abstract class Configurations<G, W, K> {
    ...
    protected final Class<K> knockbackConfigClass;
    ...
    public Configurations(
        ...
        this.knockbackConfigPlaceholderName = knockbackConfigPlaceholderName;
    }
    ...
    private void trySaveFileNode(YamlConfigurationLoader loader, ConfigurationNode node, String filename) throws ConfigurateException {
        try {
            ...
            if (ex.getCause() instanceof AccessDeniedException) {
                LOGGER.warn("Could not save {}: Nitrogen could not persist the full set of configuration settings in the configuration file. Any setting missing from the configuration file will be set with its default value in memory. Admins should make sure to review the configuration documentation at https://docs.papermc.io/paper/configuration for more details.", filename, ex);
            } else throw ex;
        }
    }
    ...
    protected W createWorldConfig(final ContextMap contextMap, final CheckedFunction<ConfigurationNode, W, SerializationException> creator) throws IOException {
        ...
        if (Files.notExists(worldConfigFile)) {
            NitrogenConfigurations.createDirectoriesSymlinkAware(dir);
    ...
    protected void verifyWorldConfigVersion(final ContextMap contextMap, final ConfigurationNode worldNode) {
        ...
        if (version.virtual()) {
            if (worldKey.equals(WORLD_DEFAULTS_KEY)) {
                ...
                LOGGER.warn("The world config file for {} didn't have a version set, assuming latest", worldKey);
            }
    ...
    public static class ContextMap {
        ...
        public static class Builder {
            ...
            public <T> ContextMap.Builder put(ContextKey<T> key, T value) {
                this.buildingMap.put(key, value);
                return this;
            }

            public ContextMap.Builder put(ContextKey<Void> key) {
