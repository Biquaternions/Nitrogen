...
public class NitrogenCommand {

    private static final Component PREFIX = MiniMessage.miniMessage().deserialize("<white><gradient:#feabff:#94ffeb>Nitrogen</gradient> <#e79eff>⮞</#e79eff> </white>");
    private static final Component FEEDBACK_RELOAD_SUCCESS = PREFIX.append(Component.text("Nitrogen configuration has been reloaded.", NamedTextColor.WHITE));
    ...
    public static void init() {
        ...
        PaperCommands.INSTANCE.registerWithFlagsInternal(null, "pufferfish", "Nitrogen", command, "Nitrogen related commands", List.of(), Set.of());
